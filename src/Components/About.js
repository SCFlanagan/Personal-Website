  ...
  return (
    <div className="about-page">
      ...
      <p className="bio o-0" id="about-animate-2">
        ...
        in Web Development and Programming. I am now seeking a full-stack
        developer position. I am based out of Massachusetts, but am hoping to
        relocate. Contact me if you'd like to connect!
      </p>
